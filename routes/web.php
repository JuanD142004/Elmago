...
Route::middleware(['auth'])->group(function () {
    ...
    Route::patch('/route/{id}/update_status', [RouteController::class, 'updateStatus'])->name('update_status');
    ...
    Route::resource('details_purchase', DetailsPurchaseController::class);
...
// Repetir la ruta de inicio de sesión para la compatibilidad
